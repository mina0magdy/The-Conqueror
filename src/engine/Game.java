...
public class Game {
	...
	public static void main(String[] args) throws IOException {
		...
		int count=1;
		Army[]x= {g.getAvailableCities().get(1).getDefendingArmy()};
	...
	for(Army a:x) {
		...
		if(a.getCurrentStatus()==Status.BESIEGING) {
			besieging+="Army "+count+"\n"+"Besieged City:"+a.getCurrentLocation()+"\n"+"Turns Under Siege: "+getCity(a.getCurrentLocation(),g.getAvailableCities()).getTurnsUnderSiege()+"\n"+"-------------"+"\n"+a.toString();	
		}
		count++;
	}
	System.out.println(idle);
	System.out.println(marching);
	System.out.println(besieging);

	
	}
	public static City getCity(String name,ArrayList<City> array) {
		for(City c:array) {
